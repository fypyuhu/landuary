<fieldset id="add-record" style="width: 500px;">
    ...
    <form method="post" action="/admin/carts/edit/{{$cart->id}}" id="pageForm">
        {{csrf_field()}}
        <div class="row">
        ...
        <div class="row">
            <div class="col s6">
                ...
                <div class="input-field">
                    <input id="number" type="text" name="cart_number" readonly="readonly" value="{{$cart->cart_number}}">
                </div>
