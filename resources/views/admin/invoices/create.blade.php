...
<section class="content-wrap">
    ...
    @if (session('status'))
        ...
        @if($rec_id)
        <a href="javascript:void(0)" id="newtab_link" onclick="window.open('/admin/invoices/{{ old('invoice_type') == 'Detailed Invoice' ? 'receipt' : 'receipt-summary' }}/{{$rec_id}}', 'Receipt', 'height=' + (screen.height-150) + ',width=' + (screen.width-150));" style="display:none;">Link</a>
        @endif
    @endif
