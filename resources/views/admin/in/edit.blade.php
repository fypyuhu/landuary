...
<section class="content-wrap">
        ...
        <div class="row">
            <div class="col s12 m9 l10">
                ...
                <ul>
                    ...
                    <li><a href='dashboard.html'>Edit Incoming Cart</a>
                    </li>
                </ul>
            </div>
    ...
    <!-- /Breadcrumb -->
    <div id="loadAjaxFrom">
        <form method="post" action="/admin/in/edit/{{$ogc->id}}" id="pageForm">
...
<script>
    $(document).ready(function () {
        ...
        $(".calendar").jqxDateTimeInput({value:new Date("@date($ogc->receiving_date)"), width: 'auto', height: '25px', formatString: 'MMMM dd, yyyy', disabled: true});
