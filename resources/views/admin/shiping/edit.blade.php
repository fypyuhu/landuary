                    ...
                    <div class="row box">
                        <div class="row layout_table no-topmargin">
                            ...
                            <div class="row records_list">
                                ...
                                <div class="col s2 center-align"><a href="/admin/out/receipt/{{$cart->id}}"   class="edit-button">View</a> | <a href="/admin/out/edit/{{$cart->id}}"  class="edit-button">Edit</a> | <a href="/admin/out/delete/{{$cart->id}}" data-mode="ajax">Delete</a></div>
                            </div>
                            @endforeach
                            @endif
