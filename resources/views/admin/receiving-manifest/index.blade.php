...
<!-- Main Content -->
  <section class="content-wrap">
    ...
    @if (session('status'))
        ...
        @if($rec_id)
        <a href="javascript:void(0)" id="newtab_link" onclick="window.open('/admin/receiving-manifest/receipt/{{$rec_id}}', 'Receipt', 'height=' + (screen.height-150) + ',width=' + (screen.width-150));" style="display:none;">Link</a>
        @endif
    @endif
