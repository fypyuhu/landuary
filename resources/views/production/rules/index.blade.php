...
<section class="content-wrap">
        ...
        <div class="row">
            <div class="col s12 m9">
                ...
                <ul>
                    ...
                    <li><a href='/production/rules'>Manage Rules</a>
                    </li>
                </ul>
            </div>
    ...
    <!-- /Breadcrumb -->
    <a data-mode="ajax" href="/production/rules/create" class="waves-effect btn create-clone-button">Add Rule</a>
    <div class="row no-rightmargin">
        <div class="col s9">
            <fieldset>
                <legend>Rules List:</legend>
                <div class="row box">
                	<form id="search_form">
                	<div class="row" style="margin-bottom:15px;">
                      <div class="pull-left">
                          <label style="font-size:12px;">Search by Rule Name or Rule Number</label>
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		var url = "{{url('production/rules/show')}}";
        ...
        $("#jqxgrid").jqxGrid(
                {
                    ...
                    filterable: true,
                    columns: [
                        {text: 'Rule Name', width:'25%',dataField: 'rule_name', sortable: false,cellsrenderer: rowRenderer},
                        {text: 'Rule Number', width:'25%' ,dataField: 'rule_number', sortable: false,cellsrenderer: rowRenderer},
                        {text: 'Rule Description', width:'25%', dataField: 'rule_description', sortable: false,cellsrenderer: rowRenderer},
                        {text: 'Running Time in Minutes', width:'25%', dataField: 'rule_time', sortable: false,cellsrenderer: rowRenderer}
                    ]
                });
	}
</script>
