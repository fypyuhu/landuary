                ...
                <fieldset>
                  ...
                  <div class="row box">
                      ...
                      <div class="row" style="margin-bottom:15px;">
                        ...
                        <div class="col m3 s12" style="padding-top:20px;"><button type="submit" class="waves-effect btn" onclick="$('#jqxgrid').jqxGrid('updatebounddata');">Sort</button></div>
                      </div>
                      @if($link <= 0)
                          @if(!isset($machine) || (isset($machine) && $machine == ''))
                              ...
                              <div class="row layout_table no-topmargin">
                                ...
                                <div class="row records_list" style="padding-top:1px; margin-bottom:2px;">
                                    <div class="col s3">&nbsp;</div>
                                    <div class="col s3">&nbsp;</div>
                                    <div class="col s3" style="font-weight:bold; background:#eeeded;">24 Hours</div>
                                    <div class="col s3" style="font-weight:bold; background:#eeeded;">200 lbs</div>
                                </div>
                                <div class="row date-group">
                      ...
                      <!--<div class="row layout_table no-topmargin">
                            ...
                            <div class="row records_list" style="padding-top:1px; margin-bottom:2px;">
                                ...
                                <div class="col s2">&nbsp;</div>
                                <div class="col s1">&nbsp;</div>
                                <div class="col s2" style="font-weight:bold; background:#eeeded;">12 Hours</div>
                                <div class="col s2" style="font-weight:bold; background:#eeeded;">200 lbs</div>
                            </div>
                            <div class="row date-group">
                            	Tuesday 16 August, 2015
                            </div>
