...
<section class="content-wrap">
        ...
        <div class="row">
            <div class="col s12 m9">
                ...
                <ul>
                    ...
                    <li><a href='/production/users'>Manage Users</a>
                    </li>
                </ul>
            </div>
    ...
    <!-- /Breadcrumb -->
    <a data-mode="ajax" href="/production/users/create" class="waves-effect btn create-clone-button">Add User</a>
            ...
            <fieldset>
                ...
                <div class="row box">
                	...
                	<div class="row" style="margin-bottom:15px;">
                      <div class="pull-left">
                          <label style="font-size:12px;">Search User</label>
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		var url = "{{url('production/users/show')}}";
        ...
        $("#jqxgrid").jqxGrid(
                {
                    ...
                    filterable: true,
                    columns: [
                        {text: 'User ID', width:'50%',dataField: 'user_id', sortable: false,cellsrenderer: rowRenderer},
                        {text: 'Password', width:'50%' ,dataField: 'user_password', sortable: false,cellsrenderer: rowRenderer}
                    ]
                });
	}
</script>
