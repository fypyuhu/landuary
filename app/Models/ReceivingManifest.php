...
class ReceivingManifest extends Model {
    ...
    public static function getCustomerIncomingCartItems($customer_id, $date1, $date2, $department_id, $view = false) {
