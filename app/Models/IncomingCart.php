...
class IncomingCart extends Model {
    ...
    public static function inCartsList($request) {
        ...
        $sql.=" AND ic.organization_id = '".Auth::user()->organization_id."' AND ic.id = cici.incoming_cart_id and ic.customer_id = c.id GROUP BY cici.incoming_cart_id ORDER BY ic.id DESC limit ".$request->recordstartindex.", ".$request->pagesize;
